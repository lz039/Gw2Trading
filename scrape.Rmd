...
```{r}
dir <- getwd()
price_list_buys <- read.csv(paste(dir, "/gw2-all-buys-raw-3103.csv", sep = ""))
price_list_sells <- read.csv(paste(dir, "/gw2-all-sells-raw-3103.csv", sep = ""))
item_list <- read.csv(paste(dir, "/gw2-all-items-raw-3103.csv", sep = ""))
