...
df_top5 <- top_n(ungroup(df_sells_group), 5, mean_unit_price)
...
`r df_top5 %>% select(mean_unit_price) %>% first() %>% first()` gold seems to be the maximum possible price for an auction.
