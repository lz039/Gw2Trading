...
```{r css-operations, message=FALSE, warning=FALSE}
...
- The "(2) green" cluster are mid-cost items with different profit
- The "(3) teal" cluster are low-cost items with mostly high profit (should buys)
- The "(4) purple" cluster are high-cost items with high profit (could buys)
