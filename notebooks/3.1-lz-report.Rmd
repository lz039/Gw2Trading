...
sells_lasso_aug %>%  
  ggplot() +
  geom_point(aes(x = .pred * 100, y = unit_price_gold_sells * 100)) +
  geom_abline(col = "red", lty = 2) +
  labs(x = "Prediction", y = "Gold value",
...
The dataset behaved very differently than I tought. There is a lot of data but the really relevant parts are only highest sell and lowest buy prices.
